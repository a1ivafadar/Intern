...
final class DoctorsConversation: MessagesViewController
{

//    @Published var conversation = Conversation()
//    @Published var user = Doctor()
   // var otherUser = Doctor()
...
extension DoctorsConversation: InputBarAccessoryViewDelegate {
...
extension DoctorsConversation: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
...
//extension DDConversation: MessageCellDelegate {
